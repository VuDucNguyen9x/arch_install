...
base_install="
	...
	zip unzip p7zip unrar tlp firefox git
"
...
if [ "$1" == "" ]; then
	...
	echo "/dev/sda1 - 200Mib will be mounted as /mnt/efi"
	echo "/dev/sda4 - rest of space will be mounted as /"
...
# EOF
	cfdisk /dev/${drive}
	mkfs.fat -F32 -L "EFI System" /dev/${drive}p1
	mkfs.ext4 -F -L "Arch Linux" /dev/${drive}p4

	mount /dev/${drive}p4 /mnt
	mkdir -pv /mnt/efi
